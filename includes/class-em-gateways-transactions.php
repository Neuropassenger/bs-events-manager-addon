...
if( !class_exists( 'EM_Gateways_Transactions' ) ) {
    class EM_Gateways_Transactions {
        public $order, $orderby, $page, $gateway;
                ...
                foreach($transactions as $key => $transaction) {
                    ...
                    <tr valign="middle" class="alternate">
                        ...
                        <td>
                            ...
                            if ( $addon_settings['booking_attendee_info'] == 'on' ) {
                                echo '<a href="'.$EM_Booking->get_person()->get_bookings_url().'&booking_id='.$transaction->booking_id.'">'. $EM_Booking->person->get_name() .'</a>';
                            } else {
                        ...
                        <td class="column-gateway">
                            <?php
                                if(!empty($transaction->transaction_gateway)) {
                                    if ( $addon_settings['gateway_readable_names'] == 'on' ) {
                                        echo Bs_Events_Manager_Addon_Booking_Helper::get_gateway_title_by_system_slug(
                                            $transaction->transaction_gateway
                                        );
                                    } else {
